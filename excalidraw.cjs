 ...
 * Stroke styles
 */
const STROKE_STYLES = Object.freeze({
  SOLID: "solid",
  DASHED: "dashed",
  DOTTED: "dotted",
});
 ...
 * Fill styles
 */
const FILL_STYLES = Object.freeze({
 ...
 */
function estimateTextDimensions(text, fontSize = 16, fontFamily = FONTS.HAND_DRAWN) {
 ...
 */
function createBaseElement(type, x, y, width, height, extra = {}) {
  return {
...
function createExcalidrawDoc(options = {}) {
